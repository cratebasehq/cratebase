      ...
      >
        ...
        >
          ...
          <button
            ...
            className="-mr-1 grid size-7 shrink-0 place-items-center rounded-[7px] text-stone-400 outline-none transition-colors duration-150 hover:bg-stone-100 hover:text-stone-700 focus-visible:bg-[#D9530F]/[0.06] focus-visible:text-stone-700 focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:text-stone-500 dark:hover:bg-white/10 dark:hover:text-stone-100 dark:focus-visible:bg-[#EF7D3E]/[0.1] dark:focus-visible:text-stone-100 dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E]"
          >
            {CLOSE_ICON}
          </button>
        </header>
