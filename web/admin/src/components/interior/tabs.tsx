    ...
    >
      ...
      {renderPanel ? (
        <motion.div
          ...
          className={`rounded-[11px] text-[13.5px] leading-relaxed text-stone-700 outline-none focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:text-stone-200 dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E] ${panelClassName}`}
        >
