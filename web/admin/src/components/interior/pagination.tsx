...
const arrow = (can: boolean) =>
  `flex h-8 w-8 shrink-0 items-center justify-center rounded-[9px] outline-none transition-colors duration-150 focus-visible:bg-[#D9530F]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:focus-visible:bg-[#EF7D3E]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E] ${
    can
              ...
              return (
                <li key={`slot-${item}`} style={{ width: slot }}>
                  <button
                    ...
                    className={`flex h-8 w-full items-center justify-center rounded-[9px] text-[12.5px] tabular-nums outline-none transition-colors duration-150 focus-visible:bg-[#D9530F]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:focus-visible:bg-[#EF7D3E]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E] ${
                      selected
