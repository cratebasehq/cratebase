                ...
                >
                  {column.sortable === false ? (
                    ...
                    <button
                      ...
                      className={`group flex h-7 w-full items-center gap-1.5 rounded-[6px] px-1.5 outline-none focus-visible:bg-[#D9530F]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:focus-visible:bg-[#EF7D3E]/[0.06] dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E] ${
                ...
                {markable && (
                  <div role="cell" className="min-w-0">
                    <button
                      ...
                      onClick={() => onMark(id)}
                      className={`flex size-[18px] items-center justify-center rounded-[5px] border outline-none focus-visible:border-[#D9530F] focus-visible:shadow-[0_1px_3px_rgba(28,25,23,0.18)] dark:focus-visible:border-[#EF7D3E] dark:focus-visible:shadow-[0_1px_3px_rgba(0,0,0,0.5)] ${
                        marked === id
                          ? "border-[#D9530F] bg-[#D9530F] text-white dark:border-[#EF7D3E] dark:bg-[#EF7D3E] dark:text-stone-900"
