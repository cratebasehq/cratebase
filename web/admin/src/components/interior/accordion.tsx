  ...
  return (
    <div>
      <div role="heading" aria-level={headingLevel}>
        <button
          {...header}
          className="flex w-full items-center gap-3 px-3.5 py-3 text-left outline-none transition-colors duration-150 hover:bg-stone-100 focus-visible:bg-[#D9530F]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:hover:bg-white/10 dark:focus-visible:bg-[#EF7D3E]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E]"
        >
          <span
