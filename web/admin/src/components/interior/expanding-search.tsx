    ...
    >
      <motion.div
        ...
        className={`absolute inset-y-0 ${
          ...
          focused
            ? "border-[#D9530F] bg-white dark:border-[#EF7D3E] dark:bg-[#252522]"
      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className={`grid size-[22px] place-items-center rounded-[6px] text-stone-500 outline-none focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-[#D9530F] dark:text-stone-400 dark:focus-visible:outline-[#EF7D3E] ${
      ...
      <motion.button
        ...
        transition={shellMotion}
        className={`absolute inset-y-0 z-10 grid w-10 place-items-center rounded-[8px] text-stone-500 outline-none focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-[#D9530F] disabled:opacity-50 dark:text-stone-400 dark:focus-visible:outline-[#EF7D3E] ${
          align === "right" ? "right-0" : "left-0"
