          ...
          return (
            <Reorder.Item
              ...
              className={`relative flex items-center gap-2.5 rounded-[9px] border bg-white px-3 py-2.5 outline-none transition-[border-color,box-shadow,background-color] duration-150 focus-visible:outline-none dark:bg-[#1D1D1A] ${
                ...
                held
                  ? "border-[#D9530F] bg-[#D9530F]/[0.04] dark:border-[#EF7D3E] dark:bg-[#EF7D3E]/[0.08]"
                  : "focus-visible:bg-[#D9530F]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:focus-visible:bg-[#EF7D3E]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E]"
              }`}
            >
              <span
                aria-hidden
