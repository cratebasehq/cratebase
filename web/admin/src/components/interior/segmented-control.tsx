        ...
        >
          {options.map((option, i) => (
            <button
              ...
              className="cursor-default rounded-[6px] outline-none focus-visible:bg-[#D9530F]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:focus-visible:bg-[#EF7D3E]/[0.08] dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E]"
            >
