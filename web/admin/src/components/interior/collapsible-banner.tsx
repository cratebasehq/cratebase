          ...
          <div className="flex items-center gap-2.5 p-2.5">
            ...
            {hasBody ? (
              <button
                ...
                className="group flex min-w-0 flex-1 items-center gap-2 rounded-[7px] text-left outline-none focus-visible:bg-[#D9530F]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:focus-visible:bg-[#EF7D3E]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E]"
              >
                <span
                  id={titleId}
            ...
            {dismissible ? (
              <button
                ...
                className="grid size-[26px] shrink-0 place-items-center rounded-[7px] text-stone-400 transition-colors duration-150 hover:bg-stone-100 hover:text-stone-700 focus-visible:outline-none focus-visible:bg-[#D9530F]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#D9530F] dark:text-stone-500 dark:hover:bg-white/10 dark:hover:text-stone-100 dark:focus-visible:bg-[#EF7D3E]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#EF7D3E]"
              >
                {CLOSE}
              </button>
            ) : null}
