...
description: "Client-side helpers: nearestTo, chat, getToolSchema(s), trackPresence."
---
...
function-calling setups, and `trackPresence` for the kind of
presence-collection pattern the kanban example implements by hand.
